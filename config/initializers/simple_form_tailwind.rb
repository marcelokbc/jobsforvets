...
SimpleForm.setup do |config|
    ...
    config.wrappers :vertical_boolean, tag: 'div', class: 'mt-4 mb-4 flex items-start', error_class: '' do |b|
      b.use :html5
      b.optional :readonly
    ...
    config.wrappers :vertical_collection, item_wrapper_class: 'flex items-center', item_label_class: 'my-1 ml-3 block text-sm font-medium text-gray-400', tag: 'div' do |b|
      b.use :html5
      b.optional :readonly
    ...
    config.wrappers :vertical_file, tag: 'div', class: '' do |b|
      ...
      b.use :full_error, wrap_with: { tag: 'p', class: 'mt-2 text-red-400 text-xs italic' }
      b.use :hint, wrap_with: { tag: 'p', class: 'mt-2 text-grey-700 text-xs italic' }
    end
  
    config.wrappers :select, tag: false, error_class: 'f', valid_class: '' do |b|
      b.use :html5
      b.optional :readonly
      b.wrapper :legend_tag, tag: 'legend', class: 'text-sm font-medium text-gray-600', error_class: 'text-red-500' do |ba|
        ba.use :label_text
      ...
      b.wrapper tag: 'div' do |ba|
        ba.use :input, class: 'flex w-auto w-auto shadow appearance-none border border-gray-300 w-full py-2 px-3 bg-white focus:outline-none focus:border-blue-500 text-gray-400 leading-4 transition-colors duration-200 ease-in-out rounded-full'
      end
      b.use :full_error, wrap_with: { tag: 'p', class: 'mt-2 text-red-500 text-xs italic' }
      b.use :hint, wrap_with: { tag: 'p', class: 'mt-2 text-grey-700 text-xs italic' }
    end
    ...
    config.wrappers :vertical_multi_select, tag: 'div', class: "mb-6 mt-1", error_class: 'f', valid_class: '' do |b|
      b.use :html5
      b.optional :readonly
      b.wrapper :legend_tag, tag: 'legend', class: 'text-sm font-medium text-gray-600', error_class: 'text-red-500' do |ba|
        ba.use :label_text
      end
      b.use :input, class: 'flex w-auto w-auto shadow appearance-none border border-gray-300 rounded w-full py-2 px-3 bg-white focus:outline-none focus:border-blue-500 text-gray-400 leading-4 transition-colors duration-200 ease-in-out'
      # b.wrapper tag: 'div' do |ba|
      ...
      #   ba.use :input, class: 'flex w-auto w-auto shadow appearance-none border border-gray-300 rounded w-full py-2 px-3 bg-white focus:outline-none focus:border-blue-500 text-gray-400 leading-4 transition-colors duration-200 ease-in-out'
      # end
      b.use :full_error, wrap_with: { tag: 'p', class: 'mt-2 text-red-500 text-xs italic' }
      b.use :hint, wrap_with: { tag: 'p', class: 'mt-2 text-grey-700 text-xs italic' }
    end
    ...
    config.wrappers :vertical_range, tag: 'div', error_class: 'text-red-500', valid_class: 'text-green-400' do |b|
      b.use :html5
      b.use :placeholder
      b.optional :readonly
      b.optional :step
